...
const copy = {
  sr: {
    ...
    intro: "PROJEKAT DANINI razvija digitalni ekosistem koji povezuje AI metodologiju, edukaciju, digitalne proizvode, zdrav stil života, vodu, affiliate marketing i realne poslovne studije slučaja. Cilj nije masovno oglašavanje bez kriterijuma, već okupljanje saradnika i proizvoda koji mogu doprineti poverenju, kvalitetu i dugoročnoj vrednosti sistema.",
    blocks: [
      ["Šta gradimo", "DaniniHub je operativni AI sistem i metodologija Pitaj AI — AI pita tebe. DaniniNet je poslovni, affiliate i prodajni portal. DaniniLans je edukativni prostor za vodu, rutinu i zdrav stil života. Čalije Park Residence je DPL Case Study za digitalnu prezentaciju lokacije."],
      ["Koga tražimo", "Otvoreni smo za saradnike iz oblasti zdravog stila života, vode, filtracije, kuhinjskih sistema, digitalnih alata, hostinga, AI edukacije, affiliate proizvoda, marketinga, dizajna, videa, građevinarstva, projektovanja, nekretnina i lokalnih usluga."],
      ["Šta mora da prođe proveru", "Svaki proizvod mora imati jasan kvalitet, realnu upotrebu, transparentnu cenu, pouzdanu isporuku, korektne uslove kupovine i jasnu politiku reklamacije. Ne promovišemo proizvode samo zato što nude proviziju."],
      ["Modeli saradnje", "Saradnja može obuhvatiti affiliate promociju, partnerski profil, product showcase, sponzorisani članak, preporuku proizvoda, zajednički edukativni sadržaj, video promociju, poslovni katalog ili regionalnu kampanju."],
      ["Pravilo poverenja", "Poverenje se ne gradi agresivnom prodajom. Gradi se jasnim sadržajem, dokazima, transparentnošću, odgovornim disclosure-om i proizvodima koji imaju prirodnu vezu sa temom sajta."],
    ],
    checklistTitle: "Provera proizvoda pre promocije",
    checklist: ["Da li proizvod ima realnu vezu sa temom sajta?", "Da li je profesionalno predstavljen?", "Da li ima jasnu cenu i uslove kupovine?", "Da li se može promovisati bez preteranih tvrdnji?", "Da li affiliate provizija ne kvari objektivnost?", "Da li proizvod jača poverenje u PROJEKAT DANINI?"],
    ctaTitle: "Predložite saradnju ili proizvod",
    ctaText: "Pošaljite kratak opis firme, proizvoda, usluge, link ka sajtu i predlog modela saradnje. Prvo radimo proveru smisla i kvaliteta, pa tek onda dogovor o objavi, showcase-u ili affiliate poziciji.",
    email: "info@daninihub.com",
    disclaimer: "Ovaj poziv nije javna ponuda, garancija objave, garancija prodaje ili automatsko prihvatanje saradnje. Svaki predlog prolazi ručnu proveru relevantnosti, kvaliteta, pravnog okvira i uklapanja u Danini sistem.",
  },
  de: {
