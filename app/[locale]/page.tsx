...
const copy: Record<Locale, Copy> = {
  sr: {
    ...
    hero: {
      ...
      title: "Digitalni marketing, AI i affiliate — bez praznih obećanja.",
      subtitle: "DaniniNet pomaže da se ideja, znanje, lokacija ili digitalni proizvod predstave kroz jasnu strukturu: sadržaj, poverenje, prodajni tok i metodu Pitaj AI — AI pita tebe.",
      primary: "Pogledaj vodič Digitalna prodaja lokacije",
      ...
      panelTitle: "Prvo struktura, zatim prodaja.",
      panelText: "DaniniHub metoda pomaže da se pre prodaje razjasne pitanja, dokazi, granice, javni sloj i sledeći korak.",
    ...
    product: { eyebrow: "Aktuelni proizvod", title: "Digitalna prodaja lokacije", text: "PDF vodič + Bonus Pack za predstavljanje parcele, stana, kuće, lokacije ili projekta kroz javni gateway, zatvoreni brief, lead tok i legal/trust sloj.", cta: "Pogledaj vodič" },
    ...
    final: { title: "Kreni od vodiča, metode ili sadržaja.", products: "Pogledaj vodič", blog: "Čitaj blog", legal: "Legal & Trust" },
  },
  de: {
    ...
    hero: { eyebrow: "DaniniNet Plattform", title: "Digitales Marketing, KI und Affiliate — ohne leere Versprechen.", subtitle: "DaniniNet hilft, Idee, Wissen, Standort oder digitales Produkt über klare Struktur zu präsentieren: Inhalt, Vertrauen, Sales Flow und die Methode Frag die KI — die KI fragt dich.", primary: "PDF-Leitfaden ansehen", secondary: "DaniniHub Methode ansehen", proof: "Digitaler Verkauf von Standorten · echtes DaniniNet Produkt", signals: ["Digitales Produkt", "Gateway-Logik", "SEO + Trust", "Gumroad Flow"], panelTitle: "Erst Struktur, dann Verkauf.", panelText: "Die DaniniHub Methode klärt Fragen, Belege, Grenzen, öffentliche Ebene und nächsten Schritt, bevor verkauft wird.", panelSteps: [["01", "Frage vor Inhalt"], ["02", "Beleg vor Aussage"], ["03", "Grenze vor CTA"], ["04", "Artefakt vor Kampagne"]] },
    ...
    product: { eyebrow: "Aktuelles Produkt", title: "Digitaler Verkauf von Standorten", text: "PDF-Leitfaden + Bonus Pack für die Präsentation von Standort, Immobilie oder Projekt über öffentlichen Gateway, geschlossenen Brief, Lead Flow und Legal/Trust Ebene.", cta: "Leitfaden ansehen" },
    ...
    final: { title: "Starte mit Leitfaden, Methode oder Inhalt.", products: "Leitfaden ansehen", blog: "Blog lesen", legal: "Legal & Trust" },
  },
  en: {
    ...
    hero: { eyebrow: "DaniniNet platform", title: "Digital marketing, AI and affiliate — without empty promises.", subtitle: "DaniniNet helps present an idea, knowledge, location or digital product through clear structure: content, trust, sales flow and the Ask AI — AI asks you method.", primary: "View the PDF guide", secondary: "See the DaniniHub method", proof: "Digital Location Sales · real DaniniNet product", signals: ["Digital product", "Gateway logic", "SEO + trust", "Gumroad flow"], panelTitle: "Structure first, then sales.", panelText: "The DaniniHub method clarifies questions, proof, boundaries, public layer and next step before selling.", panelSteps: [["01", "Question before content"], ["02", "Proof before claim"], ["03", "Boundary before CTA"], ["04", "Artifact before campaign"]] },
    ...
    product: { eyebrow: "Current product", title: "Digital Location Sales", text: "PDF guide + Bonus Pack for presenting land, property, location or project through public gateway, closed brief, lead flow and legal/trust layer.", cta: "View guide" },
    ...
    final: { title: "Start with guide, method or content.", products: "View guide", blog: "Read blog", legal: "Legal & Trust" },
  },
};
